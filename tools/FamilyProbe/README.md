...
1. Copy the `FamilyProbe` folder into `Interface/AddOns/` — `tools/Deploy.bat` does it for
   every client installed, every time, along with the addons and the icon sheet.
