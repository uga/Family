...
Family.locales.ruRU = {
	...
	["%d of %d %s accounted for"] = "%d из %d %s учтено",
	["%d of %d %s accounted for, and one ability has no price recorded"] = "%d из %d %s учтено, и для одной способности цена не записана",
	["%d of %d %s accounted for, and %d abilities have no price recorded"] = "%d из %d %s учтено, и для %d способностей цена не записана",
