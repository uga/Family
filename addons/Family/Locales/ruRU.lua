...
Family.locales.ruRU = {
	...
	["  |cffffaa00on the roster, but not recorded as being in this guild: %s|r"] = "  |cffffaa00есть в списке гильдии, но не записан(ы) как состоящий(ие) в ней: %s|r",
	["  |cff888888log in on them once and it will be filled in|r"] = "  |cff888888зайдите за них один раз, и это заполнится|r",
	["  |cffffaa00in this guild but recorded on another realm, so they are not offered: %s (this one is %s)|r"] = "  |cffffaa00в этой гильдии, но записан(ы) на другом игровом мире, поэтому не предлагаются: %s (этот — %s)|r",
	["no guild recorded"] = "гильдия не записана",
