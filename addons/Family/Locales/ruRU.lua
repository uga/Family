...
Family.locales.ruRU = {
	...
	["Show vendor prices on item tooltips"] = "Показывать цены торговцев в подсказках предметов",
	["What a vendor pays you, which the game always knows - and what a vendor charges, for the items Family has seen on a merchant's list. Nothing is claimed about an item no vendor has been seen selling."] = "Сколько торговец платит тебе - это игра знает всегда - и сколько торговец просит, для предметов, которые Family видела в списке торговца. О предмете, который никто не был замечен продающим, ничего не утверждается.",
