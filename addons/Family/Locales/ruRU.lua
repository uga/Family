...
Family.locales.ruRU = {
	...
	["what decoding every character's record costs on this client"] = "сколько стоит распаковка записи каждого персонажа на этом клиенте",
	["  Stored: %s. Uncompressed they would be about %s."] = "  Хранится: %s. Без сжатия было бы около %s.",
	["Decoding %d records took %.0f ms."] = "Распаковка %d записей заняла %.0f мс.",
	["  |cffffd700%s|r: %.1f ms, %s stored."] = "  |cffffd700%s|r: %.1f мс, хранится %s.",
