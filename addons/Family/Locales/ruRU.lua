...
Family.locales.ruRU = {
	...
	["  |cff888888the rest share a rank and nothing else until that profession's window has been opened once|r"] = "  |cff888888остальные передают только уровень, пока окно этой профессии не будет открыто хотя бы раз|r",
