...
Family.locales.ruRU = {
	...
	["this reads every page of the auction house and takes a long time: /family ah scan go"] = "это читает каждую страницу аукциона и занимает много времени: /family ah scan go",
