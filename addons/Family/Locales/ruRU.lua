...
Family.locales.ruRU = {
	...
	["|cffffd700%d item(s)|r"] = "|cffffd700предметов: %d|r",
	...
	["Reopen Family where you left it"] = "Открывать Family там, где вы остановились",
	["The panel you were last on, and the set of columns on the summary - rather than the summary's first. Kept when you log out."] = "Панель, на которой вы были, и набор столбцов в сводке — а не первый. Сохраняется после выхода из игры.",
