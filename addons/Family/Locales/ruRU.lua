...
Family.locales.ruRU = {
	...
	["less with a crafting cooldown"] = "меньше с ремесленным восстановлением",
	["less by farming"] = "меньше, если добыть самому",
	["less with a crafting cooldown and farming"] = "меньше с восстановлением и добычей",
