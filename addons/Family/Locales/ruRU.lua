...
Family.locales.ruRU = {
	...
	["  page %d of %d, %d price(s) known here"] = "  страница %d из %d, здесь известно цен: %d",
	...
	["read the whole house: %d page(s), %d price(s) known here"] = "прочитан весь аукцион: страниц: %d, здесь известно цен: %d",
