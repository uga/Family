...
Family.locales.ruRU = {
	...
	["Still sending: %d pieces are in Family's own queue - everything it has to send, not only this link. Nothing was added, because what you are asking for is already on its way."] = "Ещё отправляется: %d частей в очереди Family - всё, что ему нужно отправить, не только эта связь. Ничего не добавлено: то, что вы просите, уже в пути.",
	["   |cffffd700|||   sending, %d pieces left in the queue|r"] = "   |cffffd700|||   отправка, осталось частей: %d|r",
