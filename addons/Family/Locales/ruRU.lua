...
Family.locales.ruRU = {
	...
	["You receive: %s"] = "Вы получаете: %s",
	["You receive: %s x%d"] = "Вы получаете: %s x%d",
	...
	["  |cff888888Of the %d that are not: %d have nothing recorded as sent yet, and %d cannot be marked at all.|r"] = "  |cff888888Из %d, которые не совпали: у %d ещё ничего не записано как отправленное, а %d вообще нельзя пометить.|r",
	["%.1f KB"] = "%.1f КБ",
	["%d bytes"] = "%d байт",
