...
Family.locales.ruRU = {
	...
	["|cff888888Crafting cooldowns only - transmutes, mooncloth, salt shakers. Only the members who have one are listed. Blank means Family has not seen that member's, which is not the same as nought.%s|r"] = "|cff888888Только время восстановления ремесла - трансмутации, лунная ткань, солонка. Перечислены только участники, у которых оно есть. Пусто означает, что Family не видела его у этого участника, а это не то же самое, что ноль.%s|r",
