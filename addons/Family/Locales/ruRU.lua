...
Family.locales.ruRU = {
	...
	["|cff888888Building and fingerprinting is what each exchange costs, and there is one at every login. Marking is what the same question costs without decoding anybody. Nothing was sent.|r"] = "|cff888888Сборка и отпечаток — это цена каждого обмена, а он происходит при каждом входе. Метка — цена того же вопроса без раскодирования кого-либо. Ничего не отправлено.|r",
