...
Family.locales.ruRU = {
	...
	["  asking for page %d, %s layout - the answer follows when it arrives"] = "  запрашиваю страницу %d, раскладка %s - ответ придёт, когда придёт",
	...
	["say which layout: /family ah query long, or /family ah query short"] = "укажи раскладку: /family ah query long или /family ah query short",
