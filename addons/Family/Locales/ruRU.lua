...
Family.locales.ruRU = {
	...
	["Worth"] = "Стоимость",
	["What everything is worth"] = "Сколько всё это стоит",
	["%s across %d item(s), and %d could not be priced"] = "%s за %d предмет(ов), и %d не удалось оценить",
	["oldest price %s"] = "самая старая цена %s",
	["%d priced, %d not"] = "оценено %d, не оценено %d",
	["Nothing here has a price yet. Family learns what things are worth from the auction house while you browse it."] = "Здесь пока ни у чего нет цены. Family узнаёт стоимость на аукционе, пока вы его просматриваете.",
