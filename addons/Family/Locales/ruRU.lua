...
Family.locales.ruRU = {
	...
	["no query of the client's own has been seen this session"] = "в этой сессии не было замечено ни одного собственного запроса клиента",
	["nothing is being read"] = "ничего не читается",
	["stopped after %d page(s): %s"] = "остановлено после %d страниц(ы): %s",
	...
	["  page %d of %d, %d price(s) taken, %d known here"] = "  страница %d из %d, взято цен: %d, здесь известно: %d",
	["read the whole house: %d page(s), %d price(s) taken, %d known here"] = "прочитан весь аукцион: страниц: %d, взято цен: %d, здесь известно: %d",
