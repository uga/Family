...
Family.locales.ruRU = {
	...
	["Every price Family has taken from an auction house. Red is a price ten times or more the one it replaced, or ten times what the same item costs on the other markets. Deleting a price lets the next visit read a new one; banning an item clears its price in that market and keeps it out until the ban is lifted."] = "Все цены, которые Family взяла с аукциона. Красным отмечена цена, в десять и более раз выше той, что она заменила, или цены того же предмета на других рынках. Удалённую цену следующий визит прочтёт заново; запрет предмета стирает его цену на этом рынке и не пускает её, пока запрет не снят.",
