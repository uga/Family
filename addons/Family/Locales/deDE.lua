...
Family.locales.deDE = {
	...
	["|cff888888Crafting cooldowns only - transmutes, mooncloth, salt shakers. Only the members who have one are listed. Blank means Family has not seen that member's, which is not the same as nought.%s|r"] = "|cff888888Nur Handwerksabklingzeiten - Transmutationen, Mondstoff, Salzstreuer. Nur Mitglieder, die eine haben, werden aufgeführt. Leer bedeutet, dass Family die des Mitglieds nicht gesehen hat, was nicht dasselbe ist wie null.%s|r",
