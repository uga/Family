...
Family.locales.deDE = {
	...
	["what decoding every character's record costs on this client"] = "was das Entpacken aller Charakter-Datensätze auf diesem Client kostet",
	["  Stored: %s. Uncompressed they would be about %s."] = "  Gespeichert: %s. Unkomprimiert wären es etwa %s.",
	["Decoding %d records took %.0f ms."] = "Das Entpacken von %d Datensätzen dauerte %.0f ms.",
	["  |cffffd700%s|r: %.1f ms, %s stored."] = "  |cffffd700%s|r: %.1f ms, %s gespeichert.",
