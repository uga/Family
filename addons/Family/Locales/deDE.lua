...
Family.locales.deDE = {
	...
	["Show vendor prices on item tooltips"] = "Händlerpreise in Gegenstands-Tooltips zeigen",
	["What a vendor pays you, which the game always knows - and what a vendor charges, for the items Family has seen on a merchant's list. Nothing is claimed about an item no vendor has been seen selling."] = "Was ein Händler dir zahlt, was das Spiel immer weiß - und was ein Händler verlangt, für die Gegenstände, die Family auf einer Händlerliste gesehen hat. Über einen Gegenstand, den nachweislich kein Händler verkauft, wird nichts behauptet.",
