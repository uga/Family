...
Family.locales.deDE = {
	...
	["Worth"] = "Wert",
	["What everything is worth"] = "Was alles wert ist",
	["%s across %d item(s), and %d could not be priced"] = "%s über %d Gegenstand/Gegenstände, und %d ließen sich nicht bepreisen",
	["oldest price %s"] = "ältester Preis %s",
	["%d priced, %d not"] = "%d bepreist, %d nicht",
	["Nothing here has a price yet. Family learns what things are worth from the auction house while you browse it."] = "Hier hat noch nichts einen Preis. Family lernt Preise im Auktionshaus, während du dort stöberst.",
