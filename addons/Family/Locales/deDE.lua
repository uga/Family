...
Family.locales.deDE = {
	...
	["%d of %d %s accounted for"] = "%d von %d %s zugeordnet",
	["%d of %d %s accounted for, and one ability has no price recorded"] = "%d von %d %s zugeordnet, und für eine Fähigkeit ist kein Preis aufgezeichnet",
	["%d of %d %s accounted for, and %d abilities have no price recorded"] = "%d von %d %s zugeordnet, und für %d Fähigkeiten ist kein Preis aufgezeichnet",
