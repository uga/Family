...
Family.locales.deDE = {
	...
	["  page %d of %d, %d price(s) known here"] = "  Seite %d von %d, %d Preis(e) hier bekannt",
	...
	["read the whole house: %d page(s), %d price(s) known here"] = "ganzes Auktionshaus gelesen: %d Seite(n), %d Preis(e) hier bekannt",
