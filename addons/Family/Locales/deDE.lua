...
Family.locales.deDE = {
	...
	["  |cffffaa00on the roster, but not recorded as being in this guild: %s|r"] = "  |cffffaa00im Gildenverzeichnis, aber nicht als Mitglied dieser Gilde aufgezeichnet: %s|r",
	["  |cff888888log in on them once and it will be filled in|r"] = "  |cff888888einmal mit ihnen einloggen, dann wird es nachgetragen|r",
	["  |cffffaa00in this guild but recorded on another realm, so they are not offered: %s (this one is %s)|r"] = "  |cffffaa00in dieser Gilde, aber auf einem anderen Realm aufgezeichnet, daher werden sie nicht angeboten: %s (dieser ist %s)|r",
	["no guild recorded"] = "keine Gilde aufgezeichnet",
