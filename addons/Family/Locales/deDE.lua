...
Family.locales.deDE = {
	...
	["Still sending: %d pieces are in Family's own queue - everything it has to send, not only this link. Nothing was added, because what you are asking for is already on its way."] = "Wird noch gesendet: %d Teile liegen in Familys eigener Warteschlange - alles, was es zu senden hat, nicht nur diese Verbindung. Es wurde nichts hinzugefügt, denn was Sie verlangen, ist bereits unterwegs.",
	["   |cffffd700|||   sending, %d pieces left in the queue|r"] = "   |cffffd700|||   sendet, %d Teile in der Warteschlange|r",
