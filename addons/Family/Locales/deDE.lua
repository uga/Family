...
Family.locales.deDE = {
	...
	["  asking for page %d, %s layout - the answer follows when it arrives"] = "  frage Seite %d ab, Layout %s - die Antwort folgt, sobald sie eintrifft",
	...
	["say which layout: /family ah query long, or /family ah query short"] = "sag, welches Layout: /family ah query long oder /family ah query short",
