...
Family.locales.deDE = {
	...
	["|cff9d9d9dSwitched off until you ask for it. Sharing is the one thing here a later version cannot take back, so it waits to be asked for rather than arriving switched on - but the panel is there so you can see what it is before deciding. Tick the box on it, or |cffffd700/family wide on|r|cff9d9d9d. Both of you need to.|r"] = "|cff9d9d9dAusgeschaltet, bis du danach fragst. Teilen ist das Einzige hier, was eine spätere Version nicht zurücknehmen kann, also wartet es darauf, erbeten zu werden, statt eingeschaltet anzukommen - aber der Reiter ist da, damit du siehst, worum es geht, bevor du entscheidest. Setze dort das Häkchen, oder |cffffd700/family wide on|r|cff9d9d9d. Ihr müsst es beide tun.|r",
