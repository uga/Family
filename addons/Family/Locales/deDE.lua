...
Family.locales.deDE = {
	...
	["|cffffd700What you share with %s|r   |cff888888one profession at a time, and nothing until it is ticked|r"] = "|cffffd700Was du mit %s teilst|r   |cff888888ein Beruf nach dem anderen, und nichts, bis es angehakt ist|r",
	...
	["   |cffffaa00%d left out: this client gave no identifier for them, and a word is one language, so they cannot be shared.|r"] = "   |cffffaa00%d ausgelassen: dieser Client hat keine Kennung dafür geliefert, und ein Wort ist nur eine Sprache, also können sie nicht geteilt werden.|r",
