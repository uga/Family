...
Family.locales.deDE = {
	...
	["no query of the client's own has been seen this session"] = "in dieser Sitzung wurde keine eigene Abfrage des Clients gesehen",
	["nothing is being read"] = "es wird nichts gelesen",
	["stopped after %d page(s): %s"] = "nach %d Seite(n) gestoppt: %s",
	...
	["  page %d of %d, %d price(s) taken, %d known here"] = "  Seite %d von %d, %d Preis(e) genommen, %d hier bekannt",
	["read the whole house: %d page(s), %d price(s) taken, %d known here"] = "ganzes Auktionshaus gelesen: %d Seite(n), %d Preis(e) genommen, %d hier bekannt",
