...
Family.locales.deDE = {
	...
	["You receive: %s"] = "Du erhältst: %s",
	["You receive: %s x%d"] = "Du erhältst: %s x%d",
	...
	["  |cff888888Of the %d that are not: %d have nothing recorded as sent yet, and %d cannot be marked at all.|r"] = "  |cff888888Von den %d, die es nicht sind: bei %d ist noch nichts als gesendet vermerkt, und %d lassen sich gar nicht markieren.|r",
	["%.1f KB"] = "%.1f KB",
	["%d bytes"] = "%d Bytes",
