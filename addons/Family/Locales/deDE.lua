...
Family.locales.deDE = {
	...
	["   |cffffaa00Not offered: %s. This client did not say which profession that is, only what it is called - and a name is readable in one language, so it cannot cross.|r"] = "Nicht angeboten: %s. Dieser Client hat nicht gesagt, welcher Beruf das ist, nur wie er heißt - und ein Name ist nur in einer Sprache lesbar, er kann also nicht übertragen werden.",
