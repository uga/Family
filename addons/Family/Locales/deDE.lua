...
Family.locales.deDE = {
	...
	["  %d of %d recipe lists were read in a language other than this client's."] = "  %d von %d Rezeptlisten wurden in einer anderen Sprache als der dieses Clients gelesen.",
