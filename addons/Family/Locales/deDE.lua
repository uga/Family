...
Family.locales.deDE = {
	...
	["this reads every page of the auction house and takes a long time: /family ah scan go"] = "dies liest jede Seite des Auktionshauses und dauert lange: /family ah scan go",
