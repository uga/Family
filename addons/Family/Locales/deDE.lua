...
Family.locales.deDE = {
	...
	["  |cff888888deciding costs %d ms today: %d of %d unchanged, and an unchanged member is never opened.|r"] = "  |cff888888Entscheiden kostet heute %d ms: %d von %d unverändert, und ein unveränderter Eintrag wird nie geöffnet.|r",
	...
	["|cffffd700%s|r: %d members, building %d ms, fingerprinting %d ms, marking %d ms"] = "|cffffd700%s|r: %d Mitglieder, Aufbau %d ms, Fingerabdruck %d ms, Markierung %d ms",
	["|cff888888Building and fingerprinting is what each exchange costs, and there is one at every login. Marking is what the same question costs without decoding anybody. Nothing was sent.|r"] = "|cff888888Aufbau und Fingerabdruck sind, was jeder Austausch kostet, und bei jeder Anmeldung gibt es einen. Markierung ist, was dieselbe Frage kostet, ohne jemanden zu entschlüsseln. Es wurde nichts gesendet.|r",
