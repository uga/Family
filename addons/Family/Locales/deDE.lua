...
Family.locales.deDE = {
	...
	["A star appears on every panel in the strip; click one to make it the panel Family opens on, every time. The summary is starred with the set of columns you are looking at, so a star can mean Activity rather than the whole panel."] = "Auf jedem Panel in der Leiste erscheint ein Stern; klicke einen an, damit Family jedes Mal dort öffnet. Die Übersicht wird mit dem Spaltensatz markiert, den du gerade ansiehst - ein Stern kann also Aktivität bedeuten und nicht das ganze Panel.",
	["Open Family here"] = "Family hier öffnen",
	["|cff9d9d9dFamily opens on this panel, every time.|r"] = "|cff9d9d9dFamily öffnet jedes Mal auf diesem Panel.|r",
