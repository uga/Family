...
Family.locales.deDE = {
	...
	["      |cff9d9d9dnothing in the boon that Family has read|r"] = "      |cff9d9d9dnichts im Chronoboon, das Family gelesen hat|r",
	...
	["|cffffaa00the summary's filter row is %d pixels short - the labels are longer than the room in this language|r"] = "|cffffaa00der Filterleiste der Übersicht fehlen %d Pixel - die Beschriftungen sind länger als der Platz in dieser Sprache|r",
	["%s: nothing to make, so nothing to list"] = "%s: nichts herzustellen, also nichts aufzulisten",
	["|cff888888reading what %d characters' recipes are called. The professions page will be slow until that finishes, and quick from the next time you log in.|r"] = "|cff888888die Rezeptnamen von %d Charakteren werden gelesen. Die Berufeseite ist bis zum Ende langsam und ab der nächsten Anmeldung schnell.|r",
	["|cffffaa00Still reading what %d characters' recipes are called - this window may pause the first time you open it. It will not after that.|r"] = "|cffffaa00Die Rezeptnamen von %d Charakteren werden noch gelesen - dieses Fenster kann beim ersten Öffnen kurz stocken. Danach nicht mehr.|r",
	["|cff888888Every profession on one line per member: the two primary ones first, then the secondary skills. The button above switches to the weapon skills instead. A profession in grey has recipes Family has not seen for a week, or has never seen: ranks are always current, recipe lists are only as new as the last time that window was open.|r"] = "|cff888888Jeder Beruf auf einer Zeile je Mitglied: zuerst die beiden Hauptberufe, dann die Nebenfertigkeiten. Der Knopf darüber schaltet auf die Waffenfertigkeiten um. Ein grauer Beruf hat Rezepte, die Family seit einer Woche nicht gesehen hat oder nie: Ränge sind immer aktuell, Rezeptlisten nur so neu wie das letzte Mal, als dieses Fenster offen war.|r",
	["|cff888888Every profession on one line per member: the two primary ones first, then the secondary skills. A profession in grey has recipes Family has not seen for a week, or has never seen: ranks are always current, recipe lists are only as new as the last time that window was open.|r"] = "|cff888888Jeder Beruf auf einer Zeile je Mitglied: zuerst die beiden Hauptberufe, dann die Nebenfertigkeiten. Ein grauer Beruf hat Rezepte, die Family seit einer Woche nicht gesehen hat oder nie: Ränge sind immer aktuell, Rezeptlisten nur so neu wie das letzte Mal, als dieses Fenster offen war.|r",
	["|cff888888Every weapon this character has been trained in, and how far each has been practised. The button above switches back to the professions.|r"] = "|cff888888Jede Waffe, in der dieser Charakter ausgebildet ist, und wie weit sie geübt wurde. Der Knopf darüber schaltet zurück zu den Berufen.|r",

	-- The Options panel
	["Options"] = "Optionen",  -- 20
	["plain storage"] = "unkomprimierter Speicher",
	["plain storage, no sharing"] = "unkomprimiert, kein Teilen",
	["plain"] = "unkomprimiert",
	["plain, no sharing"] = "unkomprimiert, kein Teilen",
	["storage: plain, %d still compressed from an earlier version"] = "Speicher: unkomprimiert, %d noch von einer früheren Version komprimiert",
	["|cffffaa00LibSerialize and LibDeflate are not installed|r - nothing can be shared, and a record still compressed cannot be read"] = "|cffffaa00LibSerialize und LibDeflate sind nicht installiert|r - nichts kann geteilt werden, und ein noch komprimierter Datensatz kann nicht gelesen werden",
	...
	["|cffff5555character scan failed|r: %s"] = "|cffff5555Charakter-Scan fehlgeschlagen|r: %s",
	...
	["item %s: %d member(s), %d guild bank(s)"] = "Gegenstand %s: %d Mitglied(er), %d Gildenbank(en)",
	...
	["crafting cooldowns ready:"] = "Herstellungs-Abklingzeiten bereit:",
	...
	["%d.%02dM"] = "%d,%02dM",
	["Worth"] = "Wert",
	["worth %s   |cff888888(%d at auction prices, %d at vendor prices, %d not priced)|r"] = "Wert %s   |cff888888(%d zu Auktionspreisen, %d zu Händlerpreisen, %d ohne Preis)|r",
	["oldest price %s"] = "ältester Preis %s",
	...
	["  the browse list holds %s row(s), of %s on sale in all"] = "  die Suchliste hält %s Zeile(n), von %s insgesamt im Angebot",
	["  refused: %s"] = "  abgelehnt: %s",
	["  nothing answered within %d seconds"] = "  nichts hat innerhalb von %d Sekunden geantwortet",
	["  paging the newer house: |cffffd700%s|r"] = "  Seitenabruf des neueren Auktionshauses: |cffffd700%s|r",
	...
	["  and the page is argument %d, from two of its own queries"] = "  und die Seite ist Argument %d, aus zwei seiner eigenen Abfragen",
	["  press Next as well: two queries differing in one place say which argument is the page"] = "  drücke auch Weiter: zwei Abfragen, die sich an einer Stelle unterscheiden, sagen, welches Argument die Seite ist",
	["%s - /family ah scan stop ends it"] = "%s - /family ah scan stop beendet es",
	["a page was asked for and never arrived"] = "eine Seite wurde angefordert und kam nie an",
	["a read of the house is already running"] = "ein Durchlesen des Auktionshauses läuft bereits",
	["another addon just asked this client for the whole house at once - search the auction house yourself and try again"] = "ein anderes Addon hat den Client gerade nach dem ganzen Auktionshaus auf einmal gefragt - suche selbst und versuche es erneut",
	["press Search on the auction house first - the read replays the client's own query rather than composing one"] = "drücke zuerst im Auktionshaus auf Suchen - das Lesen wiederholt die eigene Abfrage des Clients, statt eine zu bauen",
	["nothing is being read"] = "es wird nichts gelesen",
	["stopped after %d page(s) in %s: %s"] = "nach %d Seite(n) in %s gestoppt: %s",
	["the auction house was closed"] = "das Auktionshaus wurde geschlossen",
	["the client went on refusing queries"] = "der Client lehnte Abfragen weiterhin ab",
	["the client would not take the query"] = "der Client nahm die Abfrage nicht an",
	["this walks every page of the search the auction house last made and takes a long time: /family ah scan go"] = "dies durchläuft jede Seite der letzten Suche des Auktionshauses und dauert lange: /family ah scan go",
	["read every page of that search: %d page(s) in %s, %d price(s) taken, %d known here"] = "jede Seite dieser Suche gelesen: %d Seite(n) in %s, %d Preis(e) genommen, %d hier bekannt",
	["this clears the search, then reads every page there is - it takes a long time"] = "dies leert die Suche und liest dann jede Seite, die es gibt - das dauert lange",
	["press Next on the auction house once - two queries differing in one place are what says which argument is the page"] = "drücke im Auktionshaus einmal auf Weiter - zwei Abfragen, die sich an einer Stelle unterscheiden, sagen, welches Argument die Seite ist",
	...
	["  page %d of %d, %d price(s) taken - %s gone, about %s to go"] = "  Seite %d von %d, %d Preis(e) genommen - %s vergangen, noch etwa %s",
	["read the whole house: %d page(s) in %s, %d price(s) taken, %d known here"] = "ganzes Auktionshaus gelesen: %d Seite(n) in %s, %d Preis(e) genommen, %d hier bekannt",
	["this build has no whole-list read on the auction house"] = "diese Version hat kein Lesen der ganzen Liste im Auktionshaus",
	["  the throttled message system is ready: |cffffd700%s|r"] = "  das gedrosselte Nachrichtensystem ist bereit: |cffffd700%s|r",
	["  it holds %s replicated row(s) before asking"] = "  es hält %s replizierte Zeile(n) vor der Anfrage",
	["  it holds %s replicated row(s) now, after %d answer(s)"] = "  es hält jetzt %s replizierte Zeile(n), nach %d Antwort(en)",
	["  asked for the whole list once - nothing else will be sent"] = "  die ganze Liste einmal angefragt - es wird nichts weiter gesendet",
	["  %s waiting for the server, %s while it would not send, %s of Family's own pacing"] = "  %s Warten auf den Server, %s in denen er nicht senden wollte, %s eigener Takt von Family",
	["Read it all"] = "Alles lesen",
	["Searching..."] = "Suche...",
	["Stop"] = "Anhalten",
	["%d second(s)"] = "%d Sekunde(n)",
	["%d minute(s)"] = "%d Minute(n)",
	...
	["on"] = "an",
	["off"] = "aus",
	["what this client offers on the auction house"] = "was dieser Client am Auktionshaus anbietet",
	["  a query would be accepted now: |cffffd700%s|r"] = "  eine Abfrage würde jetzt angenommen: |cffffd700%s|r",
	["  and %d of them once a random-enchantment suffix tells two apart"] = "  und %d, wenn ein zufälliges Suffix zwei unterscheidet",
	...
	["  the last loaded list: %d row(s), %d with no item, %d item(s), %d with a price"] = "  die zuletzt geladene Liste: %d Zeile(n), %d ohne Gegenstand, %d Gegenstand/Gegenstände, %d mit Preis",
	...
	["Auction"] = "Auktion",
	["Stack of %d"] = "Stapel von %d",
	["|cff888888CTRL: what the stack is worth|r"] = "|cff888888STRG: was der Stapel wert ist|r",
	...
	["|cffffd700%s|r: %d row(s), and it is specialisation %d's own list - not read."] = "|cffffd700%s|r: %d Zeile(n), und es ist die eigene Liste von Spezialisierung %d - nicht gelesen.",
	["|cffffd700%s|r: %d row(s), read."] = "|cffffd700%s|r: %d Zeile(n), gelesen.",
	["    flyout |cff888888%s|r %s, %s slot(s)"] = "    Sammelmenü |cff888888%s|r %s, %s Platz/Plätze",
	["    and %d row(s) passed over: %s"] = "    und %d Zeile(n) übergangen: %s",
	["Still receiving %d transfer. Asking again would ask everybody to start over."] = "Es wird noch %d Übertragung empfangen. Erneut zu fragen hieße, dass alle von vorn beginnen.",
	["Still receiving %d transfers. Asking again would ask everybody to start over."] = "Es werden noch %d Übertragungen empfangen. Erneut zu fragen hieße, dass alle von vorn beginnen.",
	["   |cffffd700|||   %d transfer still arriving|r"] = "   |cffffd700|||   %d Übertragung kommt noch an|r",
	["   |cffffd700|||   %d transfers still arriving|r"] = "   |cffffd700|||   %d Übertragungen kommen noch an|r",
	["|cffffd700%s|r: %d members. Now: marking %d ms, %d of %d unchanged, and an unchanged member is never opened."] = "|cffffd700%s|r: %d Mitglieder. Jetzt: Markierung %d ms, %d von %d unverändert, und ein unveränderter Eintrag wird nie geöffnet.",
	["  |cff888888What it used to cost, for comparison: building %d ms, fingerprinting %d ms.|r"] = "  |cff888888Was es früher kostete, zum Vergleich: Aufbau %d ms, Fingerabdruck %d ms.|r",
	["|cff888888Nothing was sent, and nobody had to be online.|r"] = "|cff888888Es wurde nichts gesendet, und niemand musste online sein.|r",
	["Wide Family is switched off, so there is nothing to time."] = "Weite Familie ist ausgeschaltet, es gibt also nichts zu messen.",
	["no links, so there is nothing to time."] = "keine Verbindungen, es gibt also nichts zu messen.",
	...
	["An item used a fixed number of times - an oil, a Bag of Marbles - shows what is left of it in the corner of its icon, the way the game does."] = "Ein Gegenstand mit begrenzter Anzahl von Anwendungen - ein Öl, ein Beutel Murmeln - zeigt in der Ecke seines Symbols, wie viel davon übrig ist, so wie das Spiel es tut.",
	["left-click the letters or the Chrono figure to unfold what is behind it"] = "Linksklick auf die Briefe oder die Chrono-Zahl zeigt, was dahintersteckt",
	["shift-click the money, on the button or on a broker bar, to change what it counts: the whole family, this side of this realm, or the character you are playing"] = "Shift-Klick auf das Geld, auf dem Button oder auf einer Broker-Leiste, ändert, was gezählt wird: die ganze Familie, diese Seite dieses Realms oder der Charakter, den du gerade spielst",
	...
	["mail %s"] = "Post %s",
	["Backpack"] = "Rucksack",
	["|cffe6cc80Equipped|r"] = "|cffe6cc80Angelegt|r",
	["  bag %d slot %d, item %d: |cffffd700%s|r"] = "  Tasche %d Platz %d, Gegenstand %d: |cffffd700%s|r",
	["  worn slot %d, item %d: |cffffd700%s|r"] = "  angelegter Platz %d, Gegenstand %d: |cffffd700%s|r",
	["  nothing in the bags said anything about binding"] = "  nichts in den Taschen sagte etwas über Bindung",
	["what this client can say about what is bound: /family bind"] = "was dieser Client über Bindung sagen kann: /family bind",
	["%d equipped"] = "%d angelegt",
	["%d auction"] = "%d Auktion",
	...
	["|cff9d9d9dNo quest has been recorded for anybody yet.|r"] = "|cff9d9d9dEs wurde noch für niemanden eine Quest aufgezeichnet.|r",
	["|cffffd700%d|r of %d quests   |cff888888|||r   %d with quests recorded"] = "|cffffd700%d|r von %d Quests   |cff888888|||r   %d mit aufgezeichneten Quests",
	...
	["By profession, and inside each of them by name."] = "Nach Beruf, und innerhalb jedes Berufs nach Namen.",
	["Most of the family first. A guild's crafters are counted separately."] = "Die meisten aus der Familie zuerst. Handwerker der Gilde werden getrennt gezählt.",
	["Profession"] = "Beruf",
	["Item"] = "Gegenstand",
	["How many"] = "Anzahl",
	["By item, and under each of them whoever has the most."] = "Nach Gegenstand, und darunter jeweils, wer am meisten davon hat.",
	["By character, and under each of them what they are carrying."] = "Nach Charakter, und darunter jeweils dessen Gegenstände.",
	["Most first, wherever in the family they happen to be."] = "Die meisten zuerst, egal wo in der Familie sie liegen.",
	...
	["  %s: %d recipe(s), %d with a spell id, %d with an item id, read in %s and you are reading in %s"] = "  %s: %d Rezept(e), %d mit einer Zauber-ID, %d mit einer Gegenstands-ID, gelesen in %s, Sie lesen in %s",
	...
	["|cff888888CTRL-click: %s|r"] = "|cff888888STRG-Klick: %s|r",
	["|cff888888ALT-click: %s|r"] = "|cff888888ALT-Klick: %s|r",
	...
	["Still sending to %s: %d piece(s) still to go. Nothing was added, because what you are asking for is already on its way."] = "Wird noch an %s gesendet: %d Teil(e) stehen noch aus. Es wurde nichts hinzugefügt, denn was Sie verlangen, ist bereits unterwegs.",
	["|cffffd700sending to them, %d pieces left|r"] = "|cffffd700sendet an sie, %d Teile übrig|r",
	...
	["check a pet's training points against what its abilities cost"] = "die Trainingspunkte eines Tieres gegen die Kosten seiner Fähigkeiten prüfen",
	["|cffffd700%s|r (%s): the client says %d of %d training points are spent."] = "|cffffd700%s|r (%s): der Client sagt, %d von %d Trainingspunkten sind ausgegeben.",
	["  %d priced, %d with no price in the trainer's window, %d the client would not name - and the priced ones come to |cffffd700%d|r."] = "  %d mit Preis, %d ohne Preis im Fenster des Lehrers, %d vom Client nicht benannt - und die mit Preis ergeben |cffffd700%d|r.",
	["no creature with training points is recorded yet - summon a pet on a client that has them, open Beast Training, and look again."] = "noch kein Tier mit Trainingspunkten aufgezeichnet - rufen Sie ein Tier auf einem Client herbei, der sie hat, öffnen Sie Wildtierausbildung und sehen Sie erneut nach.",
	...
	["Nothing to send to %s: %d unchanged. Asked for theirs."] = "Nichts an %s zu senden: %d unverändert. Nach ihren gefragt.",
	["|cffffd700nothing to send, %d unchanged|r"] = "|cffffd700nichts zu senden, %d unverändert|r",
	["|cff888888Update now sends what changed. To send every member again, whatever they hold: /family wide resend %s|r"] = "|cff888888Erneuern sendet, was sich geändert hat. Um alle Mitglieder erneut zu senden, egal was sie haben: /family wide resend %s|r",
	["Which family? /family wide resend <family>. Linked: %s."] = "Welche Familie? /family wide resend <Familie>. Verknüpft: %s.",
	["Sending every member again to %s, whatever they already hold: %d member(s), about %d KB and %s on the wire. Update now sends only what changed."] = "Alle Mitglieder werden erneut an %s gesendet, egal was sie schon haben: %d Mitglied(er), etwa %d KB und %s in der Leitung. Erneuern sendet nur, was sich geändert hat.",
	["|cffffd700/family wide resend <family>|r sends every member to that family again, whatever they hold."] = "|cffffd700/family wide resend <Familie>|r sendet alle Mitglieder erneut an diese Familie, egal was sie haben.",
	...
	["none of %s's characters is on a realm this character can reach"] = "keiner der Charaktere von %s ist auf einem Realm, den dieser Charakter erreichen kann",
	["|cffffaa00None of %s's characters is on a realm this character can reach.|r Nothing was sent. A whisper reaches your own realm and the realms connected to it."] = "|cffffaa00Keiner der Charaktere von %s ist auf einem Realm, den dieser Charakter erreichen kann.|r Es wurde nichts gesendet. Ein Flüstern erreicht nur deinen eigenen Realm und die mit ihm verbundenen.",
	...
	["|cffffaa00Wide Family is switched off, so what you tick here is kept and not sent. It goes once the feature is switched on and you press Update now.|r"] = "|cffffaa00Die Weite Familie ist ausgeschaltet, was du hier ankreuzt, wird also gemerkt und nicht gesendet. Es geht hinaus, sobald sie eingeschaltet ist und du Erneuern drückst.|r",
	...
	["Draw the carried bags as one block, and the bank as another"] = "Getragene Taschen als einen Block zeigen, die Bank als einen weiteren",
	["On the Possessions panel: the backpack and every bag you carry become one run of slots called Bags, and the bank with its bags one called Bank. The keyring, the mail and each guild bank tab stay as they are."] = "Im Besitz-Panel: Rucksack und alle getragenen Taschen werden eine Reihe von Plätzen namens Taschen, die Bank mit ihren Taschen eine namens Bank. Schlüsselbund, Post und jedes Gildenbankfach bleiben, wie sie sind.",
	["Fold long lists to fit the page"] = "Lange Listen passend zur Seite falten",
	["Where a list is longer than the page, each group shows its first few names and a line saying how many more. Untick it to see every name, and scroll."] = "Ist eine Liste länger als die Seite, zeigt jede Gruppe ihre ersten Namen und eine Zeile, wie viele es noch sind. Abwählen, um jeden Namen zu sehen und zu scrollen.",
	...
	["Open and close Family"] = "Family öffnen und schließen",
	["Could not update: %s"] = "Aktualisierung nicht möglich: %s",
	["|cffffaa00Could not ask the guild: %s|r"] = "|cffffaa00Gilde konnte nicht gefragt werden: %s|r",
	...
	["name the frame the pointer is resting on, five seconds from now"] = "den Rahmen unter dem Zeiger benennen, in fünf Sekunden",
	["point at it and wait five seconds"] = "zeige darauf und warte fünf Sekunden",
	["  the client named nothing under the pointer"] = "  der Client hat nichts unter dem Zeiger benannt",
	["  %d of %d row(s) read, %d price(s) taken"] = "  %d von %d Zeile(n) gelesen, %d Preis(e) genommen",
	["read the whole house: %d row(s) in %s, %d price(s) taken, %d known here"] = "ganzes Auktionshaus gelesen: %d Zeile(n) in %s, %d Preis(e) genommen, %d hier bekannt",
	["the client answered no rows at all"] = "der Client hat überhaupt keine Zeile geantwortet",
	["this build has the older auction house, which is read a page at a time"] = "diese Version hat das ältere Auktionshaus, das Seite für Seite gelesen wird",
	["|cff888888(CTRL-ALT-click to open the family's list)|r"] = "|cff888888(STRG-ALT-Klick öffnet die Liste der Familie)|r",
	...
	["  modified clicks heard since login: |cffffd700%d|r"] = "  modifizierte Klicks seit dem Anmelden gehört: |cffffd700%d|r",
	["hold your modifiers and click an item: the next one will say what it held"] = "halte deine Modifikatoren und klicke einen Gegenstand an: der nächste sagt, was er hielt",
	["|cff888888the whole list is on Family's %s page, under %s|r"] = "|cff888888die ganze Liste steht auf Familys Seite %s, unter %s|r",
	["|cff66bbffFamily possessions|r"] = "|cff66bbffFamily-Besitz|r",
	["|cff66bbffFamily possessions: %s|r"] = "|cff66bbffFamily-Besitz: %s|r",
	...
	["    the window shows %d row(s): %d header(s), %d recipe(s)"] = "    das Fenster zeigt %d Zeile(n): %d Überschrift(en), %d Rezept(e)",
	["    have materials: %s"] = "    Material vorhanden: %s",
	["no such control"] = "kein solches Element",
	...
	["Banned %s"] = "Gesperrt %s",
	["%d-%d of %d"] = "%d-%d von %d",
	["No auction prices collected yet."] = "Noch keine Auktionspreise gesammelt.",
	["Ten times or more the price it replaced, %s"] = "Zehnmal oder mehr der Preis, den er ersetzt hat, %s",
	["Ten times or more what it costs on the other markets, %s"] = "Zehnmal oder mehr als auf den anderen Märkten, %s",
	["Every price Family has taken from an auction house. Red is a price ten times or more the one it replaced, or ten times what the same item costs on the other markets. Deleting a price lets the next visit read a new one. Banning an item keeps its price in that market out of Worth and recipe costs, while new readings are still taken and shown here - lift the ban when they look right again."] = "Jeder Preis, den Family in einem Auktionshaus gelesen hat. Rot ist ein Preis, der zehnmal oder mehr so hoch ist wie der, den er ersetzt hat, oder wie derselbe Gegenstand auf den anderen Märkten kostet. Wird ein Preis gelöscht, liest der nächste Besuch einen neuen. Wird ein Gegenstand gesperrt, zählt sein Preis auf diesem Markt nicht mehr für den Wert und die Rezeptkosten, während neue Preise weiter gelesen und hier gezeigt werden - heben Sie die Sperre auf, wenn sie wieder stimmen.",
	...
	["made with a crafting cooldown"] = "mit einer Herstellungs-Abklingzeit hergestellt",
	["Total with a crafting cooldown"] = "Summe mit Herstellungs-Abklingzeit",
	["Total by farming"] = "Summe durch Farmen",
	["Total with a crafting cooldown and farming"] = "Summe mit Abklingzeit und Farmen",
	["Let Family read the whole auction house itself"] = "Family das ganze Auktionshaus selbst lesen lassen",
	["Adds a Family tab to the auction window with a button that walks every page there is. It takes minutes, because the game only lets one search out at a time - so if you already run an auction addon, use its own full scan instead and Family will hear it. This is for people who do not."] = "Fügt dem Auktionsfenster einen Family-Reiter mit einem Knopf hinzu, der jede Seite durchgeht. Das dauert Minuten, weil das Spiel immer nur eine Suche gleichzeitig hinauslässt - hast du bereits ein Auktionsaddon, nutze dessen eigenen Komplettscan, Family hört mit. Dies ist für alle, die keines haben.",
	["letting Family read the whole house itself is switched off - turn it on under Extras, or use your auction addon's own full scan and Family will hear it"] = "Family das ganze Haus selbst lesen zu lassen ist ausgeschaltet - schalte es unter Extras ein, oder nutze den Komplettscan deines Auktionsaddons, Family hört mit",
	["You collected: %s"] = "Du hast eingenommen: %s",
	["|cff66bbffTotal collected:|r %s"] = "|cff66bbffInsgesamt eingenommen:|r %s",
	...
	["  |cff888888Of the %d that are not: %d changed since they were sent, %d never confirmed as sent, and %d cannot be marked at all.|r"] = "  |cff888888Von den %d, die es nicht sind: %d seit dem Senden geändert, %d nie als gesendet bestätigt, und %d lassen sich gar nicht markieren.|r",
	["what every character's record weighs, and which recipe lists are in another language"] = "was der Datensatz jedes Charakters wiegt und welche Rezeptlisten in einer anderen Sprache sind",
	["%d records: %d stored plain, %d still compressed from an earlier version."] = "%d Datensätze: %d unkomprimiert, %d noch von einer früheren Version komprimiert.",
	["  Decoding the ones still compressed took %.0f ms; each is rewritten plain the first time Family reads it."] = "  Das Entpacken der noch komprimierten dauerte %.0f ms; jeder wird unkomprimiert neu geschrieben, sobald Family ihn liest.",
	["  They weigh about %s serialised."] = "  Sie wiegen serialisiert etwa %s.",
	["  |cffffd700%s|r: about %s."] = "  |cffffd700%s|r: etwa %s.",
	["  Of %d recipe lists, %d were read in a language other than this client's (%s) and %d carry no language at all."] = "  Von %d Rezeptlisten wurden %d in einer anderen Sprache als der dieses Clients (%s) gelesen, und %d tragen gar keine Sprache.",
	["what marking each part of this character's record would cost"] = "was das Markieren jedes Teils des Datensatzes dieses Charakters kosten würde",
	["Nothing is recorded for this character yet, so there is nothing to time."] = "Für diesen Charakter ist noch nichts aufgezeichnet, also gibt es nichts zu messen.",
	["This session, %d minutes: %d record writes."] = "In dieser Sitzung, %d Minuten: %d Schreibvorgänge.",
	["  |cffffd700%s|r: written %d times, marking it takes %.1f ms."] = "  |cffffd700%s|r: %d-mal geschrieben, das Markieren dauert %.1f ms.",
	["  Marking the whole record takes %.1f ms."] = "  Den ganzen Datensatz zu markieren dauert %.1f ms.",
	["which part of the character scan costs what: /family scancost"] = "welcher Teil des Charakter-Scans was kostet: /family scancost",
	["Timing the character scan for %s, a part at a time so that each is given its own budget."] = "Der Charakter-Scan für %s wird gemessen, Teil für Teil, damit jeder sein eigenes Zeitbudget bekommt.",
	["  |cffffd700%s|r: %d read, %.0f ms."] = "  |cffffd700%s|r: %d gelesen, %.0f ms.",
	["  |cffffd700achievements|r: %d categories, %d achievements, %d criteria, %.0f ms, the slowest category %.0f ms."] = "  |cffffd700achievements|r: %d Kategorien, %d Erfolge, %d Kriterien, %.0f ms, langsamste Kategorie %.0f ms.",
	["The parts together: %.0f ms, and a part that never printed is where the client stopped. |cff888888Nothing was stored. Reading the reputations makes the game announce a change, so an ordinary scan follows a couple of seconds from now.|r"] = "Die Teile zusammen: %.0f ms, und ein Teil, der nie erschienen ist, ist die Stelle, an der der Client abgebrochen hat. |cff888888Es wurde nichts gespeichert. Das Lesen des Rufs lässt das Spiel eine Änderung melden, daher folgt in ein paar Sekunden ein gewöhnlicher Scan.|r",
	["|cff888888Nothing was changed.|r"] = "|cff888888Es wurde nichts verändert.|r",
	["  |cff888888Changed since sent: %s|r"] = "  |cff888888Seit dem Senden geändert: %s|r",
	["  |cff888888Never confirmed as sent: %s|r"] = "  |cff888888Nie als gesendet bestätigt: %s|r",
	["%.1f KB"] = "%.1f KB",
	["%d bytes"] = "%d Bytes",
	["Wide Family is switched off, so there is nothing to weigh."] = "Wide Family ist ausgeschaltet, es gibt also nichts zu wiegen.",
	["an unknown amount"] = "eine unbekannte Menge",
	["no links, so there is nothing to weigh."] = "keine Verbindungen, es gibt also nichts zu wiegen.",
	["The browse list is empty. Open the auction house, search for something common - cloth, herbs - and ask again."] = "Die Suchliste ist leer. Öffne das Auktionshaus, suche nach etwas Gängigem - Stoff, Kräuter - und frag noch einmal.",
	["Browse list: %d auctions, %d with a seller named."] = "Suchliste: %d Auktionen, bei %d ist ein Verkäufer genannt.",
	["  named in full on %d of them; the rest give a short name, which carries no realm."] = "  bei %d davon voll genannt; der Rest nennt einen Kurznamen, der kein Realm trägt.",
	["|cffffaa00No listing here names its seller in full, and a short name carries no realm - so this reading cannot settle whether the house is shared. Post an item on one realm of the group and search for it at another realm's house.|r"] = "|cffffaa00Keine Auktion hier nennt ihren Verkäufer voll, und ein Kurzname trägt kein Realm - diese Messung kann also nicht klären, ob das Auktionshaus geteilt wird. Stelle einen Gegenstand auf einem Realm der Gruppe ein und suche ihn im Auktionshaus eines anderen.|r",
	["This realm: %s. Connected to it, as the client says: %s."] = "Dieser Realm: %s. Damit verbunden, laut Client: %s.",
	["none"] = "keine",
	["this realm"] = "dieser Realm",
	["connected"] = "verbunden",
	["not in this group"] = "nicht in dieser Gruppe",
	["|cff40c040%d auctions here are from another realm of this group: this auction house is shared across the group.|r"] = "|cff40c040%d Auktionen hier stammen von einem anderen Realm dieser Gruppe: dieses Auktionshaus wird von der ganzen Gruppe geteilt.|r",
	["|cffffaa00No seller from another realm of this group on this list. That does not prove the house is separate - search for something traded widely and ask again.|r"] = "|cffffaa00Kein Verkäufer von einem anderen Realm dieser Gruppe in dieser Liste. Das beweist nicht, dass das Haus getrennt ist - suche nach etwas viel Gehandeltem und frag noch einmal.|r",
	["whose auctions this house holds, by the seller's realm"] = "wessen Auktionen dieses Auktionshaus hält, nach dem Realm des Verkäufers",
	["what an exchange would put on the wire, without sending it"] = "was ein Austausch senden würde, ohne ihn zu senden",
	["|cffffaa00LibSerialize and LibDeflate are not loaded|r, so nothing here can be weighed the way it would really go."] = "|cffffaa00LibSerialize und LibDeflate sind nicht geladen|r, daher kann hier nichts so gewogen werden, wie es wirklich ginge.",
	["|cffffd700%s|r: %d mark(s) held of theirs, %s on the wire, %s before compression."] = "|cffffd700%s|r: %d Markierung(en) von ihnen gehalten, %s auf der Leitung, %s vor der Komprimierung.",
	["|cffffd700%s|r: the payload could not be encoded."] = "|cffffd700%s|r: die Nutzlast konnte nicht kodiert werden.",
	["  merchant item info: %s"] = "  Händler-Artikelinfo: %s",
	["  loot slot %d: link %s, info %s"] = "  Beuteplatz %d: Verweis %s, Info %s",
	...
	["%d item priced at auction prices"] = "%d Gegenstand zu Auktionspreisen bewertet",
	["%d items priced at auction prices"] = "%d Gegenstände zu Auktionspreisen bewertet",
	["%d item priced at vendor prices"] = "%d Gegenstand zu Händlerpreisen bewertet",
