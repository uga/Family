...
Family.locales.deDE = {
	...
	["|cffffd700%d item(s)|r"] = "|cffffd700%d Gegenstand/Gegenstände|r",
	...
	["Reopen Family where you left it"] = "Family dort wieder öffnen, wo du aufgehört hast",
	["The panel you were last on, and the set of columns on the summary - rather than the summary's first. Kept when you log out."] = "Das zuletzt geöffnete Panel und der Spaltensatz der Übersicht - statt des ersten. Bleibt über das Ausloggen hinaus erhalten.",
